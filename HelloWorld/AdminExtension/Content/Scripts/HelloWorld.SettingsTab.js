...
/*globals,jQuery,trace,cdm,HelloWorldAdminExtension,waz,Exp*/
(function ($, global, Shell, Exp, undefined) {
    ...
    function onSaveSettings() {
        ...
        newSettings = $.extend(true, {}, global.HelloWorldAdminExtension.Controller.getCurrentAdminSettings());
        ...
        global.HelloWorldAdminExtension.Controller.updateAdminSettings(newSettings)
    ...
    function onDiscardSettings() {
        renderPage(global.HelloWorldAdminExtension.Controller.getCurrentAdminSettings());
        updateContextualCommands(false);
    }
    ...
    global.HelloWorldAdminExtension.SettingsTab = {
        loadTab: loadTab,
        cleanup: cleanup
    };
