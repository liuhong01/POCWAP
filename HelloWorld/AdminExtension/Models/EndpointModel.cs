...
namespace Microsoft.WindowsAzurePack.Samples.HelloWorld.AdminExtension.Models
{   
    ...
    public class EndpointModel
    {
        ...
        public TenantEndpoint ToTenantEndpoint()
        {
            return new TenantEndpoint()
            {
                ...
                AuthenticationUsername = this.Username,
                AuthenticationPassword = this.Password,
                SourceUriTemplate = string.Format(CultureInfo.InvariantCulture, "{{subid}}/services/{0}/{{*path}}", HelloWorldClient.RegisteredServiceName),
